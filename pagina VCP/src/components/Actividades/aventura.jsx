...
export const aventuras = [
  ...
  {
    titulo: 'Canyoning en los Arroyos',
    descripcion: 'Descubre cascadas, saltos y recorridos de agua en un circuito emocionante pensado para vivir la naturaleza de manera intensa.',
    direccion: 'Arroyos de la Sierra, Villa Carlos Paz',
    tiempo: 'de 3 a 5 horas',
    telefono: '+54 3541 42-1717',
    precio: 'Desde $5,500 por persona',
    imagen: avent1,
    horarios: 'Lunes a Domingo: 9:00 AM - 5:00 PM',
  },
  {
    titulo: 'Escalada en Roca',
    descripcion: 'Practica escalada con guía profesional en paredes de diferentes niveles, con seguridad y aventura en cada tramo.',
    direccion: 'Sector de la Cueva, Villa Carlos Paz',
    tiempo: 'de 2 a 4 horas',
    telefono: '+54 3541 42-1818',
    precio: 'Desde $4,800 por persona',
    imagen: avent1,
    horarios: 'Lunes a Domingo: 8:00 AM - 4:00 PM',
  },
  {
    titulo: 'Kayak en el Lago',
    descripcion: 'Recorre las tranquilas aguas del lago en una experiencia de aventura, paisaje y conexión con la naturaleza.',
    direccion: 'Lago San Roque, Villa Carlos Paz',
    tiempo: 'de 1 a 3 horas',
    telefono: '+54 3541 42-1919',
    precio: 'Desde $3,800 por persona',
    imagen: avent1,
    horarios: 'Lunes a Domingo: 10:00 AM - 6:00 PM',
  },
  {
    titulo: 'Mountain Bike en Sierra',
    descripcion: 'Recorré senderos desafiantes y panorámicos en bicicletas con rutas ideales para principiantes y expertos.',
    direccion: 'Senderos del Cerro, Villa Carlos Paz',
    tiempo: 'de 2 a 5 horas',
    telefono: '+54 3541 42-2020',
    precio: 'Desde $3,200 por persona',
    imagen: avent1,
    horarios: 'Lunes a Domingo: 7:00 AM - 3:00 PM',
  },
  {
    titulo: 'Rappel en la Cima',
    descripcion: 'Experimenta la adrenalina de descender por paredones con equipos de seguridad y guías especializados.',
    direccion: 'Mirador de la Cima, Villa Carlos Paz',
    tiempo: 'de 2 a 3 horas',
    telefono: '+54 3541 42-2121',
    precio: 'Desde $6,200 por persona',
    imagen: avent1,
    horarios: 'Lunes a Domingo: 9:00 AM - 5:00 PM',
  },
];
        ...
        <section className="aventura-grid">
          {aventuras.map((aventura) => (
            <article className="aventura-card" key={aventura.titulo}>
              ...
              <p>tiempo estimado: {aventura.tiempo}</p>
